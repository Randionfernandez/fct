    ...
    <fieldset class="border p-2">
        ...
        <div class="row align-items-start">
            ...
            <div class="mb-3 col-auto">
                ...
                <input class="form-control" type="tel" name="telefono1_emp" value="{{old('telefono1_emp')}}" id="telefono1_emp"  placeholder="971 123 456">
            </div>
    ...
    <fieldset class="border p-2">
        ...
        <div class="row align-items-start">
            ...
            <div class="mb-3 col-auto">
                ...
                <input class="form-control" type="tel" name="telefono1_ct" value="{{old('telefono1_ct')}}" id="telefono1_ct"  placeholder="971 123 456">
            </div>
